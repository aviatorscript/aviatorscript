...
public class SeqMapFunctionUnitTest {
  ...
  public void testMap_Array() {
    ...
    AviatorObject result = fun.call(AviatorEvaluator.FUNC_MAP, AviatorRuntimeJavaType.valueOf(strs),
  ...
  public void testMap_Map() {
    ...
    m.put("b", "2");
    SeqMapFunction fun = new SeqMapFunction();
    AviatorObject result = fun.call(AviatorEvaluator.FUNC_MAP, AviatorRuntimeJavaType.valueOf(m),
